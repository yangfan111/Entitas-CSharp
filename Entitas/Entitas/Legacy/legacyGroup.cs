...
//     public class Group<TEntity> : IGroup<TEntity> where TEntity : EntityExt
//     {
//         /// <summary>
//         ///     -当前group内包含的entitias
//         /// </summary>
...
//                             ? (addEntitySilently(entity) ? OnEntityAddedWithComp : null)
//                             : (removeEntitySilently(entity) ? OnEntityRemovedWithCmp : null);
//         }
//
...
//         {
//             if (addEntitySilently(entity) && OnEntityAddedWithComp != null)
//             {
