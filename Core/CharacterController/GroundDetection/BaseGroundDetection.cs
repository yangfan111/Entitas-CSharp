...
namespace ECM.Components
{
    ...
    {
        private static readonly LoggerAdapter Logger = new LoggerAdapter(typeof(BaseGroundDetection));

        private CharacterControllerAdapter _objAdapter;
        ...
        public CharacterControllerAdapter ObjAdapter
        {
            get { return _objAdapter; }
        ...
        {
            get { return isOnGround && isValidGround; }
        }
        ...
        public bool wasGrounded
        {
            get
            {
                return prevGroundHit.isOnGround && prevGroundHit.isValidGround;
            }
        }
        ...
        {
            get { return prevGroundHit.isOnGround; }
        }
        ...
        [SerializeField]
        private float _groundLimit = 45.0f;
        ...
        public ICapsuleCollider capsuleCollider
        {
            get
            {
                if (_capsuleCollider == null)
                    _capsuleCollider = ObjAdapter.CapsuleCollider;
        ...
        {
            get { return !isOnGround ? 0.0f : Vector3.Angle(surfaceNormal, ObjAdapter.transform.up); }
        }
        ...
        {
            var layer = ObjAdapter.gameObject.layer;
        ...
        public Collider[] OverlapCapsule(Vector3 position, Quaternion rotation, out int overlapCount)
        {
            ...
            for (var i = 0; i < colliderCount; i++)
            {
                ...
                if (overlappedCollider != null && overlappedCollider != capsuleCollider.collider)
                    continue;
        ...
        {
<<<<<<< HEAD
            return PhysicsCastHelper.Raycast(origin, direction, out hitInfo, distance, groundMask, triggerInteraction,
                backstepDistance);
        }
...
>>>>>>> dd9404d40605492fb1a883a3bed4cad8c5b8b20a
        ...
        {
            _cachedLayer = ObjAdapter.gameObject.layer;
            ObjAdapter.gameObject.layer = _ignoreRaycastLayer;
        }
        ...
        {
            ObjAdapter.gameObject.layer = _cachedLayer;
        }
        ...
        {
            var up = ObjAdapter.transform.up;

            prevGroundHit = new GroundHit(_groundHitInfo);
            _groundHitInfo = new GroundHit
            {
                groundPoint = ObjAdapter.transform.position,
                groundNormal = up,
                surfaceNormal = up
            };
        }
        ...
        public void DetectGround()
        {
            ...
            ComputeGroundHit(ObjAdapter.transform.position, ObjAdapter.transform.rotation, ref _groundHitInfo, castDistance);
        ...
        public virtual void TestDrawGizmos()
        {
            ...
            // Surface normal
            color = isValidGround ? Color.green : Color.blue;
        ...
        protected virtual void DrawGizmos()
        {
            ...
            Handles.DrawSolidDisc(stepPoint, ObjAdapter.transform.up, 0.1f);
        ...
        /// <summary>
        /// Unity function, Initialize this.
        /// </summary>

        public virtual void Awake()
        {
            InitializeOverlapMask();
            _ignoreRaycastLayer = UnityLayerManager.GetLayerIndex(EUnityLayerName.User);
        }
