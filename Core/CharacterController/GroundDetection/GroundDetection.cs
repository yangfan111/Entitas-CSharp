...
namespace ECM.Components
{
    ...
    public sealed class GroundDetection : BaseGroundDetection
    {
        ...
        protected override void DrawGizmos()
        {
            ...
            Gizmos.matrix = Matrix4x4.TRS(ObjAdapter.transform.position, ObjAdapter.transform.rotation, ObjAdapter.transform.lossyScale);
            ...
            Handles.matrix = Matrix4x4.TRS(ObjAdapter.transform.position, ObjAdapter.transform.rotation, ObjAdapter.transform.lossyScale);
