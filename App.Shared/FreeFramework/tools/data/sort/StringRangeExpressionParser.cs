...
{
	public class StringRangeExpressionParser : IExpressionParser
	{
		public const string TYPE = "sr";
		...
		public override IValueOrder Parse(string type)
		{
			...
			return new RangeStringValueOrder(Sharpen.Collections.ToArray(values, new string[] {  }));
		}
