...
namespace App.Shared.GameModules.Weapon
{
    ...
    public class DefaultWeaponEffectLogic : IWeaponEffectLogic
    {
        ...
        public void PlayBulletDropEffect(PlayerWeaponController controller)
        {
            ...
            if (null != ejectTrans)
            {
                ClientEffectFactory.CreateBulletDrop(_context, _idGenerator, controller.OwnerKey, ejectTrans.position, controller.RelatedOrient.Yaw, controller.RelatedOrient.Pitch, _config.BulletDrop);
            }
            else
            {
        ...
        public void PlayMuzzleSparkEffect(PlayerWeaponController controller)
        {
            ...
            if (null != muzzleTrans)
            {
                ClientEffectFactory.CreateMuzzleSparkEffct(_context, _idGenerator, controller.OwnerKey, muzzleTrans, controller.RelatedOrient.Pitch, controller.RelatedOrient.Yaw, _config.Spark);
            }
            else
            {
        ...
        public void PlayPullBoltEffect(PlayerWeaponController controller)
        {
            ...
            ClientEffectFactory.CreateGrenadeExplosionEffect(_context, _idGenerator,
                            controller.OwnerKey, effectPos, effectYaw, effectPitch, effectId, effectTime, EClientEffectType.PullBolt);
        }
    }
}
