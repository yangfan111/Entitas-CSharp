...
namespace App.Shared.WeaponLogic
{
    public static class PlayerEntityBagEx
    {
        ...
        public static WeaponEntity AddWeaponEntity(this PlayerEntity playerEntity, Contexts contexts, WeaponScanInfo weaponInfo)
        {
            var weaponEntity = contexts.weapon.CreateEntity();
            weaponEntity.AddWeaponBasicInfo();
            weaponEntity.AddWeaponRuntimeInfo();
            weaponInfo.ToWeaponComponent(weaponEntity.weaponBasicInfo);
            ...
            weaponEntity.AddOwner(playerEntity.entityKey.Value);
            return weaponEntity;
        }
