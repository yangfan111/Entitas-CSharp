...
{
    public class DiveController: BaseCharacterController
    {

        private static readonly LoggerAdapter Logger = new LoggerAdapter(typeof(DiveController));
        ...
        /// <param name="obstructionNormal"></param>
        /// <param name="stableOnHit"></param>
