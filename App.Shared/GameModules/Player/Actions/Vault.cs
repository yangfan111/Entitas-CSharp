...
{
    public class Vault : IAction
    {
        private static LoggerAdapter _logger = new LoggerAdapter(typeof(Vault));
        ...
        public void TriggerAnimation()
        {
            ...
            _player.stateInterface.State.StartClimb((float)GenericActionKind.Vault, () => {
