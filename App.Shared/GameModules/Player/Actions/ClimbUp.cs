...
{
    public class ClimbUp : IAction
    {
        private static LoggerAdapter _logger = new LoggerAdapter(typeof(ClimbUp));
        ...
        public void TriggerAnimation()
        {
            ...
            _player.stateInterface.State.StartClimb((float) GenericActionKind.Climb, () =>
            {
                _logger.InfoFormat("Finish Climb");
                ResetConcretAction();
